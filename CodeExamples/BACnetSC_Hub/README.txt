...
and also a tree coming from the BACnet/SC Refercence Stack (https://sourceforge.net/projects/bacnet-sc-reference-stack/) :
...
# In "own" directory the Hub application certificate can be found (with private key).
